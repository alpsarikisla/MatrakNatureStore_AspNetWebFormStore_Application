<%@ Page Title="" Language="C#" MasterPageFile="~/YonetimPaneli/YoneticiMaster.Master" AutoEventWireup="true" CodeBehind="KategoriDuzenle.aspx.cs" Inherits="MatrakNatureWebApp.YonetimPaneli.KategoriDuzenle" %>
    ...
    <div class="formTasiyici">
        ...
        <div class="formIcerik">
            <asp:Panel ID="pnl_basarili" runat="server" CssClass="basariliPanel" Visible="false">
                <label>Kategori Düzenleme Başarılı</label>
            </asp:Panel>
            ...
            <div class="satir" style="padding-top: 15px">
                <asp:LinkButton ID="lbtn_duzenle" runat="server" CssClass="formButon" OnClick="lbtn_duzenle_Click">Kategori Düzenle
                </asp:LinkButton>
            </div>
        </div>
    </div>
